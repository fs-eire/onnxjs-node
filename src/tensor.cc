...
const size_t DATA_TYPE_ELEMENT_SIZE_MAP[] = {
  ...
  0,  // ONNX_TENSOR_ELEMENT_DATA_TYPE_INT64         INT64 not working in Javascript
  0,  // ONNX_TENSOR_ELEMENT_DATA_TYPE_STRING        not supported
  1,  // ONNX_TENSOR_ELEMENT_DATA_TYPE_BOOL
  2,  // ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT16       FLOAT16 not working in Javascript
  8,  // ONNX_TENSOR_ELEMENT_DATA_TYPE_DOUBLE
  4,  // ONNX_TENSOR_ELEMENT_DATA_TYPE_UINT32
  0,  // ONNX_TENSOR_ELEMENT_DATA_TYPE_UINT64        UINT64 not working in Javascript
...
const napi_typedarray_type DATA_TYPE_TYPEDARRAY_MAP[] = {
  napi_uint8_array,    // ONNX_TENSOR_ELEMENT_DATA_TYPE_UNDEFINED     not supported
  ...
  napi_uint8_array,    // ONNX_TENSOR_ELEMENT_DATA_TYPE_INT64         INT64 not working i
  napi_uint8_array,    // ONNX_TENSOR_ELEMENT_DATA_TYPE_STRING        not supported
  napi_uint8_array,    // ONNX_TENSOR_ELEMENT_DATA_TYPE_BOOL
  napi_int8_array,     // ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT16       FLOAT16 not working
  napi_float64_array,  // ONNX_TENSOR_ELEMENT_DATA_TYPE_DOUBLE
  napi_uint32_array,   // ONNX_TENSOR_ELEMENT_DATA_TYPE_UINT32
  napi_uint8_array,    // ONNX_TENSOR_ELEMENT_DATA_TYPE_UINT64        UINT64 not working 
  napi_uint8_array,    // ONNX_TENSOR_ELEMENT_DATA_TYPE_COMPLEX64     not supported
  napi_uint8_array,    // ONNX_TENSOR_ELEMENT_DATA_TYPE_COMPLEX128    not supported
  napi_uint8_array     // ONNX_TENSOR_ELEMENT_DATA_TYPE_BFLOAT16      not supported
};
...
Tensor Tensor::From(Napi::Value val, const char * name) {
  ...
  if (floor(dataTypeDouble) != dataTypeDouble || dataTypeDouble < 0 || dataTypeDouble > ONNX_TENSOR_ELEMENT_DATA_TYPE_COUNT) {
